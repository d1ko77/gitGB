...
Чтобы удалиdadть локальную ветку в Git нужно выполdadaнить кdadоманду (вместо 'name branch' необходимо поставитdadadь название ветки, которую вы хотите удалить):

***"git branch -d 'name branch'"***

Обратите внимdadание на то, что ветка, которую вы удалdadaяете, не должна быть вашейdadada текущей веткой, в которой вы работdadaаете, иначе отобразится ошибка вида:

    error: Cannot delete branch ’mybranch’ checked out at ’/path/to

Поэтdadadому, если вам нужно удалить текущую ветку, то сначала нужно переключиться на какdadaую-либо dadaдругую ветку, а только потом выпоdadadaлнять уdadаление.

Если вдруг возникает ошибка: 

    The branch ’mybranch’ is not fully merged. If you are sure you want to delete it 

и вы по прежdadaнему хотите удалить ветку, то для принудитaddaельного удаления ветки можно воdadaспользоваться опdadaцией -D:
